...
addpath('/MATLAB Drive/Matlab_GB_ROM_Creator/')
...
alphabet_address = load_alphabet('/MATLAB Drive/Matlab_GB_ROM_Creator/Alphabet');
numbers_address = load_numbers('/MATLAB Drive/Matlab_GB_ROM_Creator/Alphabet');
